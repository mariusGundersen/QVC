...
public class HandlerMap<E extends Executable, H extends Handler> {	
	...
	public void addClassesInPackage(Reflections reflections, Class<? extends H> handlerType, Class<? extends E> executableType) {
		for (Class<? extends H> handler : reflections.getSubTypesOf(handlerType)) {
